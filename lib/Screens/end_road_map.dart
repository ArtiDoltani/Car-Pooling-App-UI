import 'package:car_pooling_and_ride_sharing_app/Screens/end_ride.dart';
import 'package:car_pooling_and_ride_sharing_app/widgets/decor_widget.dart';
import 'package:flutter/material.dart';

class EndRoadMap extends StatefulWidget {
  const EndRoadMap({Key? key}) : super(key: key);

  @override
  State<EndRoadMap> createState() => _EndRoadMapState();
}

class _EndRoadMapState extends State<EndRoadMap> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: UiHelper.CustomAppBar("Roadmap", () {
